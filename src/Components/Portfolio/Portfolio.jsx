			...
			<div className={`${Styles.work} work`}>
				<div className={Styles.work_container}>
					<div className={Styles.bork_container}>
						<h3>My Projects</h3>
						<a href="https://bork0.herokuapp.com/" rel="noreferrer" target={"_blank"}>
					...
					<div className={Styles.works_container}>
						...
						<div className={Styles.work_flexbox}>
							<a href="https://brutemarkov.netlify.app/" rel="noreferrer" target={"_blank"}>
							...
							<a href="https://pratik1803.github.io/prtk/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
							...
							<a href="https://portfoliotype1.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
							...
							<a href="https://pratikvaidya.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
							...
							<a href="https://prtk.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
							...
							<a href="https://calm-your-mind.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
									<img src={fun1} alt="" />
									<div className={Styles.work_heading}>
										<p>Calm Your Mind</p>
							...
							<a href="https://random-anime-quotes.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
									<img src={fun2} alt="" />
									<div className={Styles.work_heading}>
							...
							<a href="https://pratik1803.github.io/De-Laze/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
									<img src={fun3} alt="" />
									<div className={Styles.work_heading}>
										<p>De-Laze</p>
							...
							<a href="https://chillmountains.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
							...
							<a href="https://parallax1.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
							...
							<a href="https://gsapanimated.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
							...
							<a href="https://clothingwebsite.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
									<img src={gsap1} alt="" />
									<div className={Styles.work_heading}>
							...
							<a href="https://awesomefullpageanimation.netlify.app/" rel="noreferrer" target={"_blank"}>
								<div className={Styles.individual_work}>
									<img src={gsap2} alt="" />
									<div className={Styles.work_heading}>
